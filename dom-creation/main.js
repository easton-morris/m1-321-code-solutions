...
function renderPokemon(pokemon) {
  ...
  var pokeDes = document.createElement('p');
  pokeDes.textContent = pokemon.description;
  pokeText.appendChild(pokeDes);
...
for (var i = 0; i < pokedex.length; i++) {
  var pokeItem = renderPokemon(pokedex[i]);
  $row.appendChild(pokeItem);
}
